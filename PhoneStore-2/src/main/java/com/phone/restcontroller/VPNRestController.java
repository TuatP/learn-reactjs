...
import com.phone.form.VPNForm;
import com.phone.ultis.ConfigVNPay;

@RestController
@CrossOrigin
public class VPNRestController {
	
	@PostMapping("/create-payment")
	public ResponseEntity<String> createPayment(@RequestBody VPNForm req) {
